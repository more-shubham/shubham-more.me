...
const title = page.value?.seo?.title || page.value?.title || 'Projects - Shubham More'
const description = page.value?.seo?.description || page.value?.description || 'Explore software engineering projects, open source tools, and applications created by Shubham More.'
